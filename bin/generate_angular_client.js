...
const SOURCE_FILENAME = 'openapi.json';
...
async function main() {
  ...
  const { stdout, stderr } = await exec(
    ...
    generate -i /local/${SOURCE_FILENAME} -g typescript-angular --additional-properties=enumPropertyNaming=UPPERCASE,serviceSuffix=HttpService,fileNaming=kebab-case -o /gen`,
  );
  if (stderr) {
